...
# pip install transformers torch llama-index-embeddings-huggingface
...
def main():
    ...
    parser.add_argument("--docs_dir", type=str, default="./docs/", help="Directory containing documents to index")
    parser.add_argument("--persist_dir", type=str, default="./docs_llama_index/", help="Path to store the serialized VectorStore")
